...
TRANSLATIONS <- list(
  de = list(
    ...
    layer_share_avg_rent = "Leistbarkeit der durchschn. Angebotsmiete",
    layer_slider         = "Leistbarkeit pro CHF",
    ...
    popup_vacant_count    = "Leerstehende Wohnungen",
  ...
  en = list(
    ...
    layer_share_avg_rent = "Affordability of Avg. Asking Rent",
    layer_slider         = "Affordability per CHF",
    ...
    popup_vacant_count    = "Vacant Dwellings",
  ...
  zh = list(
    ...
    layer_share_avg_rent = "\u5e73\u5747\u79df\u91d1\u8d1f\u62c5\u80fd\u529b",
    layer_slider         = "\u6bcf CHF \u8d1f\u62c5\u80fd\u529b",
  ...
  th = list(
    ...
    layer_share_avg_rent = "\u0e04\u0e27\u0e32\u0e21\u0e2a\u0e32\u0e21\u0e32\u0e23\u0e16\u0e43\u0e19\u0e01\u0e32\u0e23\u0e08\u0e48\u0e32\u0e22\u0e04\u0e48\u0e32\u0e40\u0e0a\u0e48\u0e32\u0e40\u0e2a\u0e19\u0e2d\u0e40\u0e09\u0e25\u0e35\u0e48\u0e22",
    layer_slider         = "\u0e04\u0e27\u0e32\u0e21\u0e2a\u0e32\u0e21\u0e32\u0e23\u0e16\u0e43\u0e19\u0e01\u0e32\u0e23\u0e08\u0e48\u0e32\u0e22\u0e15\u0e48\u0e2d CHF",
    ...
    popup_vacant_count    = "\u0e08\u0e33\u0e19\u0e27\u0e19\u0e17\u0e35\u0e48\u0e2d\u0e22\u0e39\u0e48\u0e2d\u0e32\u0e28\u0e31\u0e22\u0e27\u0e48\u0e32\u0e07",
